...
async function main() {
  ...
  const receiver = new web3.PublicKey("FzY5Ak4icpxgBWBK2xjMCy7Fv8pFyHKfNvbUMTKKgXt9");
  ...
  .use(
    ...
    await createTokenMetadata(
      ...
      user,
      "Kapgan", // Token name - REPLACE THIS WITH YOURS
      "KPGN",     // Token symbol - REPLACE THIS WITH YOURS
      "Hodl guys!" // Token description - REPLACE THIS WITH YOURS
    )
}
